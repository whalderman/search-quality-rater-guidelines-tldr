...
**クエリ：**<span class="query">私のBMIはいくつか？</span>  
**ユーザーの意図：**<!-- -->BMIを計算したい。
...
**クエリ：**<span class="query">開く アングリーバード</span>  
...
**クエリ：**<span class="query">母にテキストメッセージ</span>  
**ユーザーの所在地：**<!-- -->ワシントン州タコマ  
...
- 「アプリインストール」や「アプリダウンロード」等のスマートフォン機能クエリ・機能のRBの評価を行う時は、特記がなければAndroidユーザー視点で評価を行う。
