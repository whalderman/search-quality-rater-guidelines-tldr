...
何を評価すべき：アクションそのものの有用性に基づいて、役に立つかを評価する。
...
**クエリ：**<span class="query">タイタニック IMDb</span>  
...
**クエリ：**<span class="query">cnn health</span>  
...
**クエリ：**<span class="query">london time</span>  
...
**クエリ：**<span class="query">motorcycles</span>  
...
**クエリ：**<span class="query">wral</span>  
...
**クエリ：**<span class="query">american beauty</span>  
**ユーザーの所在地：**<!-- -->カリフォルニア州マウンテンビュー  
**ユーザーの意図：**<!-- -->この映画について知りたい
...
**クエリ：**<span class="query">starting order for today's nascar race</span>  
**ユーザーの所在地：**<!-- -->テキサス州デントン  
**ユーザーの意図：**<!-- -->ナスカーレースの出走順を知りたい
...
**クエリ：**<span class="query">air canada phone number</span>  
**ユーザーの所在地：**<!-- -->ワシントン州シアトル  
**ユーザーの意図：**<!-- -->同社カスタマーサービスの電話番号を知りたい
