...
2. 選んだ文章や語句を引用符で囲み、Googleの検索ボックス内に貼り付けて検索する。ページからいくつかの文章を試してみること。
   ...
   ---|---
   ページ内の文：<br><br>All are convinced by Dorothy that the Wizard can help them too|引用符のある場合とない場合、どちらも試す：<br><br>[`"All are convinced by Dorothy that the Wizard can help them too"`](https://www.google.com/search?q="All+are+convinced+by+Dorothy+that+he+Wizard+can+help+them+too")<br><br>[`All are convinced by Dorothy that the Wizard can help them too`](https://www.google.com/search?q=All+are+convinced+by+Dorothy+that+he+Wizard+can+help+them+too)
   ページ内のフレーズ：<br><br>Dorothy uses the Golden Cap to summon the Winged Monkeys|引用符のある場合とない場合、どちらも試す：<br><br>[`"Dorothy uses the Golden Cap to summon the Winged Monkeys"`](https://www.google.com/search?q="Dorothy+uses+the+Golden+Cap+to+summon+the+Winged+Monkeys")<br><br>[`Dorothy uses the Golden Cap to summon the Winged Monkeys`]((https://www.google.com/search?q=Dorothy+uses+the+Golden+Cap+to+summon+the+Winged+Monkeys))
   ページ内の異なるフレーズ：<br><br>revealing an old man who had journeyed to Oz from Omaha long ago in a hot air balloon|引用符のある場合とない場合、どちらも試す：<br><br>[`"revealing an old man who had journeyed to Oz from Omaha long ago in a hot air balloon"`](https://www.google.com/search?q="revealing+an+old+man+who+had+journeyed+to+Oz+from+Omaha+long+ago+in+a+hot+air+balloon")<br><br>[`revealing an old man who had journeyed to Oz from Omaha long ago in a hot air balloon`](https://www.google.com/search?q=revealing+an+old+man+who+had+journeyed+to+Oz+from+Omaha+long+ago+in+a+hot+air+balloon)
...
[Lowest: Deceptive page purpose – Social media profile](https://guidelines.raterhub.com/images/ten_gop-t.jpg)（YMYL）|<ul><li>Deceptive purpose: non-satirical page made by an impersonator</li></ul>|![lowest quality][lest]<br><br>This Twitter profile page (username TEN_GOP) was created to impersonate the Tennessee Republican Party (username TNGOP)<br><br>. For more information, see this article: Fake Tennessee GOP Twitter account highlighted in indictment of 13 Russians.
